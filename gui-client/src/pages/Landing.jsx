  ...
  return (
    <div style={{ width: '100vw', height: '100vh', position: 'relative', overflow: 'hidden' }}>
      ...
      <div style={{ position: 'relative', zIndex: 1, width: '100%', height: '100%', display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
        <header style={{ background: 'rgba(119, 119, 119, 0.1)', backdropFilter: 'blur(10px)', padding: '30px', width: '96%', maxWidth: '1000px', marginTop: '40px', borderRadius: '100px', textAlign: 'center', border: '1px solid rgba(119, 119, 119, 0.41)', display: 'flex', alignItems: 'center', justifyContent: 'space-between', boxSizing: 'border-box' }}>
