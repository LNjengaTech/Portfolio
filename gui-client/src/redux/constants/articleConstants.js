...
//admin
export const ARTICLE_LIST_ALL_REQUEST = 'ARTICLE_LIST_ALL_REQUEST';
export const ARTICLE_LIST_ALL_SUCCESS = 'ARTICLE_LIST_ALL_SUCCESS';
export const ARTICLE_LIST_ALL_FAIL = 'ARTICLE_LIST_FAIL';
