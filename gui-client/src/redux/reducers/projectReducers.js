...
//new -  Image upload reducer
export const projectImageUploadReducer = (state = {}, action) => {
  switch (action.type) {
    case PROJECT_IMAGE_UPLOAD_REQUEST:
      return { loading: true };
    case PROJECT_IMAGE_UPLOAD_SUCCESS:
      return { loading: false, success: true, imageUrl: action.payload };
    case PROJECT_IMAGE_UPLOAD_FAIL:
      return { loading: false, error: action.payload };
    case PROJECT_IMAGE_UPLOAD_RESET:
      return {};
    default:
      return state;
  }
