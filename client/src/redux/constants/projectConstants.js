...
//new - image upload constants
export const PROJECT_IMAGE_UPLOAD_REQUEST = 'PROJECT_IMAGE_UPLOAD_REQUEST';
export const PROJECT_IMAGE_UPLOAD_SUCCESS = 'PROJECT_IMAGE_UPLOAD_SUCCESS';
export const PROJECT_IMAGE_UPLOAD_FAIL = 'PROJECT_IMAGE_UPLOAD_FAIL';
export const PROJECT_IMAGE_UPLOAD_RESET = 'PROJECT_IMAGE_UPLOAD_RESET';